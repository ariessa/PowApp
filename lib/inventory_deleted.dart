...
class InventoryDeleted extends StatefulWidget {

  @override
  _InventoryDeletedState createState() => _InventoryDeletedState();
}

class _InventoryDeletedState extends State<InventoryDeleted> {
