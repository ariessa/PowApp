...
class InventoryAdded extends StatefulWidget {

  @override
  _InventoryAddedState createState() => _InventoryAddedState();
}

class _InventoryAddedState extends State<InventoryAdded> {
