...
class CustomerDeleted extends StatefulWidget {

  @override
  _CustomerDeletedState createState() => _CustomerDeletedState();
}

class _CustomerDeletedState extends State<CustomerDeleted> {
