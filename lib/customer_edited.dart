...
class CustomerEdited extends StatefulWidget {

  @override
  _CustomerEditedState createState() => _CustomerEditedState();
}

class _CustomerEditedState extends State<CustomerEdited> {
